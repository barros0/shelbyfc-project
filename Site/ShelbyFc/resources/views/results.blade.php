                    ...
                    @if ($proximo_jogo->result_home || $proximo_jogo->result_opponent)
                        <div class="match-day">
                            <div class="match-details">
                                <span
                                    class="match-date">{{ $data = date('d M y', strtotime($proximo_jogo->datetime_game)) }}</span>
                                <span
                                    class="match-hours">{{ $hora = date('H:i', strtotime($proximo_jogo->datetime_game)) }}</span>
                            ...
                            <div class="teams">
                                ...
                                <div class="match-result-container">
                                    <div class="result-bg"><span
                                            class="match-result">{{ $proximo_jogo->result_home }}</span></div>
                                </div>
                                <div class="match-vs-half"><span class="match-type">Amigável</span>
                                    <h3 class="match-day-vs">VS</h3>
                                </div>
                                <div class="match-result-container">
                                    <div class="result-bg"><span
                                            class="match-result">{{ $proximo_jogo->result_opponent }}</span></div>
                                </div>

                                <div class="match-away-team">
                                    <img src="{{ asset('images/liga/' . $proximo_jogo->opponent->image) }}"
                                        alt="{{ $proximo_jogo->opponent->name }}" class="match-team">
