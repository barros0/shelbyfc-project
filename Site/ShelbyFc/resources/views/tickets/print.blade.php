...
<div class="cardWrap">
    <div class="card cardLeft">
        <h1>Jogo:<span> {{$ticket->game->opponent->name}} - #{{$ticket->game->id}}</span></h1>
        <div class="title">
            <h2>Shelby FC VS {{$ticket->game->opponent->name}}</h2>
            <span>{{$ticket->game->local}}</span>
        </div>
        <div class="name">
            <h2>{{$ticket->user->name}}</h2>
            <span>Adquirido por:</span>
        </div>
        <div class="seat">
            <h2>{{$ticket->id}}</h2>
            <span>Nº</span>
        ...
        <div class="time">
            <h2>{{$ticket->game->datetime_game}}</h2>
            <span>Data de jogo</span>
        </div>
