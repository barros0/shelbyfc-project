...
@section('title','Novo contacto de '.$contact->name)
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        &nbsp;</p>
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 18px; line-height: 25.2px; color: #666666;">Recebemos o seu contacto partir do website:</span>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        &nbsp;</p>
                                                                    <p>
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 18px; line-height: 25.2px; color: #666666;">Iremos responder-te o mais breve possivel :) </span>
                                                                    </p>
                                                                </div>
