...
@section('title','A sua subscrição foi aceite.')
                                                ...
                                                <div
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        &nbsp;</p>
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 18px; line-height: 25.2px; color: #666666;">A sua subscrição no foi aceite. Seja Bem-Vindo!</span>
                                                                    </p>
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        &nbsp;</p>
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="font-size: 18px; line-height: 25.2px; color: #666666;">Para isufrir dos novos beneficios faça entre na sua conta: </span>
                                                                    </p>
                                                                </div>
                                                    ...
                                                    <table style="font-family:'Lato',sans-serif;" role="presentation">
                                                        ...
                                                        <span style="display:block;padding:15px 40px;line-height:120%;"><span
                                                                style="font-size: 18px; line-height: 21.6px;">Fazer login</span></span>
                                                                    </a>
                                                                </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;"><span
                                                                            style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
                                                                                    style="font-size: 16px; line-height: 22.4px;">Caso não tenha feito nenhum subscrição intencional, entre em contacto clicando <a
                                                                                        href="{{route('contacts')}}">aqui</a> .</span></em></span><br/><span
                                                                            style="color: #888888; font-size: 14px; line-height: 19.6px;"><em><span
