            ...
            <div class="row text-center mx-0 g-0 py-0 px-3 col-lg-8">
                ...
                <div id="details_screen" style="display: none">
                    <div class="match-day">
                        ...
                        <div class="teams">
                            <div class="match-home-team">
                                <img src="{{ asset('images/liga/shelby_fc.png') }}" alt="Shelby FC"
                                     class="match-team-bilheteira">
                    ...
                    <form action="{{route('tickets.buy')}}" method="post">
                        @csrf
                        <div id="tickets_nostock" class="container_details_tickets flex-wrap row" id="tickets_form">

                            <div class="d-flex flex-column flex-wrap justify-content-evenly">
                                <h2>Bilhetes esgotados</h2>
                            </div>
                        </div>

                        <div class="container_details_tickets flex-wrap row" id="tickets_form">
                                ...
                                <div class="game-selected px-3 d-flex flex-column flex-wrap justify-content-evenly">
                                    ...
                                    <div class="row g-0 m-0 p-0">
                                       ...
                                       <span id="stock_tickets"></span></span></h6>
                                            <span class="details-montante-ticket"><span class="text-start"
                                                                                        style="color:#000">BILHETES
                                    </span> <span class="text-end" style="color:#000"><span
                                                        class="cinza-montante">Máx:</span> 5 Bilhetes / Jogo</span></span>
                                            <input name="quantidade" id="quantidade" type="number"
                                                   placeholder="Quantidade" min="1" max="5">
                                            <div class="montantes-rapidos">
                                                <button type="button" class="bt_add_value btn-secondary" value="1">1
                                                </button>
                                                <button type="button" class="bt_add_value btn-secondary" value="3">3
                                                </button>
                                                <button type="button" class="bt_add_value btn-secondary" value="5">5
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="game-selected px-3 d-flex flex-column flex-wrap justify-content-evenly">
                                    ...
                                    <div class="row g-0 m-0 p-0">
                                        ...
                                        <div class="montante-bilhetes">
                                            ...
                                            <h2 class="text-primary preco" @if(Auth::user()->subscribed) hidden
                                                @endif id="price_normal">0€</h2>

                                            <h2 class="text-primary preco" @if(!Auth::user()->subscribed) hidden
                                                @endif id="price_partner">0€</h2>
                        ...
                        <div class="pay-tickets">
                            ...
                            <div class="row g-0 m-0 p-0 ">
                                <button type="submit" class="text-uppercase btn-registo">Prosseguir Para Pagamento
                                </button>
                            </div>
                        </div>
            ...
            $('.game-bet-option').on('click', function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.stock_tickets >= 1) {
                            $('#tickets_nostock').addClass('hidden')
                            $('#tickets_form').removeClass('hidden')
                        } else {
                            $('#tickets_nostock').removeClass('hidden')
                            $('#tickets_form').addClass('hidden')
                        }
